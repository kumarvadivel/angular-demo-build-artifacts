(self.webpackChunkintegreat=self.webpackChunkintegreat||[]).push([["default-node_modules_angular_animations_fesm2022_animations_mjs"],{9969:(x,u,a)=>{a.r(u),a.d(u,{AUTO_STYLE:()=>p,AnimationBuilder:()=>c,AnimationFactory:()=>d,AnimationMetadataType:()=>i,NoopAnimationPlayer:()=>T,animate:()=>D,animateChild:()=>R,animation:()=>v,group:()=>F,keyframes:()=>P,query:()=>O,sequence:()=>_,stagger:()=>w,state:()=>E,style:()=>S,transition:()=>A,trigger:()=>g,useAnimation:()=>C,\u0275AnimationGroupPlayer:()=>j,\u0275BrowserAnimationBuilder:()=>f,\u0275PRE_STYLE:()=>B});var m=a(820),o=a(5742),i=function(e){return e[e.State=0]="State",e[e.Transition=1]="Transition",e[e.Sequence=2]="Sequence",e[e.Group=3]="Group",e[e.Animate=4]="Animate",e[e.Keyframes=5]="Keyframes",e[e.Style=6]="Style",e[e.Trigger=7]="Trigger",e[e.Reference=8]="Reference",e[e.AnimateChild=9]="AnimateChild",e[e.AnimateRef=10]="AnimateRef",e[e.Query=11]="Query",e[e.Stagger=12]="Stagger",e}(i||{});
/**
